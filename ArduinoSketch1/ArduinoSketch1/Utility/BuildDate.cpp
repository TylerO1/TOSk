...
/************************************************************  
DO NOT MODIFY 
Automatically Generated On 2013-06-07 07-41-PM by pre-build98 
*************************************************************/ 
 
#if defined(BUILDINFO_RAM) 
static const char* BUILD_DATE = "2013-06-07 07-41-PM"; 
#elif defined(BUILDINFO_EEMEM) 
static const char BUILD_DATE[HeaderMsgSize] EEMEM = "2013-06-07 07-41-PM"; 
#elif defined(BUILDINFO_PROGMEM) 
static const char BUILD_DATE[] PROGMEM = "2013-06-07 07-41-PM"; 
#endif 
